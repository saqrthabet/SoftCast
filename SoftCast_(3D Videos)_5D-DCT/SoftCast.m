...
%% 5D SoftCast on 3D videos (Texture plus Depth)
% sending only 1 Frame of the texture 
...
TextureVideoFile = '/Users/saqr/Documents/VIDEOS/kendo%d.yuv';       % on Mac Machine 
%TextureVideoFile = 'D:\\CQUPT\\Test_Sequence\\kendo%d.yuv';        % on Windows Machine 
DepthMapFile = '/Users/saqr/Documents/VIDEOS/depth_kendo_%d.yuv';    % on Mac Machine 
%DepthMapFile = 'D:\\CQUPT\\Test_Sequenc/VIDEOS/depth_kendo_%d.yuv'; % on Windows Machine 
...
for f = 1 : tFrame
    %% Video Input
    TextureVIn = ReadVideoDataFromFile(TextureVideoFile, VideoWidth, VideoHeight, GopSize, f, VideoOrder);
    DepthVIn = ReadVideoDataFromFile(DepthMapFile, VideoWidth, VideoHeight, GopSize, f, VideoOrder);
    ...
    dctM = mirt_dctn(VIn);
    clear VIn;
%RGB = imread('lena512color.tiff'); % supposed to be omited
